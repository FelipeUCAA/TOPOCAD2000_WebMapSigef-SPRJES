...
var style_reasdeQuilombolas_5 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    var maxResolution =75;  // Resolução máxima (maior valor de resolução, menor zoom)
    ...
    var style = [ new ol.style.Style({
        ...
        fill: new ol.style.Fill({
            color: 'rgba(93,231,38,0.5)'  // Verde com 50% de opacidade
        }),
